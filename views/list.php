	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('tribe-events-event clearfix'); ?> itemscope itemtype="http://schema.org/Event">
			...
			<div class="comments-link">
				<?php comments_popup_link( '<span class="leave-reply">' . __( 'Reply', 'tribe-events-calendar' ) . '</span>', _x( '1', 'comments number', 'tribe-events-calendar' ), _x( '%', 'comments number', 'tribe-events-calendar' ) ); ?>
			</div>
			</header>
